...
class MessageViewModel(BaseModel):
    ...
    MessageViewModel
    """ # noqa: E501
    unique_id: UUID = Field(description="Unique identifier for the message", alias="uniqueId")
    var_from: Optional[List[StrictStr]] = Field(description="Array of sender email addresses", alias="from")
    ...
    subject: Optional[StrictStr] = Field(description="Email subject line")
    body: Optional[StrictStr] = Field(description="Email body content")
